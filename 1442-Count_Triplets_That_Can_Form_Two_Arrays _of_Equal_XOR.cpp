...
int countTriplets3(vector<int> &arr)
{
    ...
    {
        int x = prefixXor[k];
        ans+= countOfXor[x]*k - sumOfi[x] - countOfXor[x]*1;
...
int main()
{
    ...
    cout << "Third Approach = " << countTriplets3(arr) << endl;
    cout << "Fourth Approach = " << countTriplets4(arr) << endl;
    return 0;
}
